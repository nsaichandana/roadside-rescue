      ...
      <div className="px-5">
        <div className="rounded-3xl bg-card border border-border p-6 shadow-card text-center">
          ...
          <p className="text-xs text-muted-foreground mt-4">
            Hold to broadcast emergency alert
          </p>
        ...
        <div className="mt-5 bg-gradient-emergency text-emergency-foreground rounded-2xl p-5 shadow-emergency">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/85 mt-1">
                Your emergency profile, GPS location, and SOS information are ready for emergency response coordination.
              </p>
            </div>
          </div>
        </div>
