    ...
    try {
      ...
      await Promise.race([
        ...
        new Promise((_, reject) =>
          setTimeout(() => reject(new Error("Timeout saving profile")), 10000)
        ),
      ]);
  ...
  return (
    <div className="min-h-screen bg-background pb-10">
      <header className="px-5 pt-6 pb-4 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold">Emergency Setup</h1>
      ...
      <form onSubmit={handleSubmit} className="px-5 space-y-4">
        ...
        <Field
          ...
          onChange={(value) => setFormData({ ...formData, emergency1: value })}
        />
        <Field
          icon={Phone}
          ...
          onChange={(value) => setFormData({ ...formData, emergency2: value })}
        />
