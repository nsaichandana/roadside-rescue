...
function detectEmergencyType(input: string): EmergencyType {
  ...
  // --- FIRE (check before medical — smoke/burn overlap) ---
  if (
    text.includes("fire") ||
    text.includes("smoke") ||
  ...
  // --- SECURITY (check before medical — "attack" overlap) ---
  if (
    text.includes("robbery") ||
    text.includes("theft") ||
    text.includes("stolen") ||
    text.includes("locked out") ||
    text.includes("lock out") ||
    text.includes("crime") ||
  ...
  if (
    ...
    text.includes("fuel") ||
    text.includes("car won") ||
    text.includes("vehicle won") ||
    text.includes("won't start") ||
    text.includes("won't move") ||
...
function Emergency() {
  ...
  const handleAnalyze = () => {
    ...
    localStorage.setItem("roadsos-analysis", JSON.stringify(analysisData));
    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <section className="px-5 mt-6">
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm font-semibold">Quick emergency chips</p>
          <button
            onClick={saveDraft}
        ...
        <div className="bg-card border border-border rounded-2xl p-4 shadow-card">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Describe your situation in your own words — the AI will detect
                whether it's medical, vehicle, fire, or security and route you
